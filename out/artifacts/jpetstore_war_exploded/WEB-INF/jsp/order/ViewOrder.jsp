	...
	<tr>
		...
		<table>
			...
			<c:forEach var="lineItem" items="${sessionScope.order.lineItems}">
				<tr>
					<td>
					<a href="ItemView?itemId=${lineItem.item.itemId}" name="itemId" value="${lineItem.item.itemId}">${lineItem.item.itemId}</a>
					</td>
			...
			<tr>
				<th colspan="5">Total: ${sessionScope.order.totalPrice}</th>
			</tr>
		</table>
		</td>
	</tr>
